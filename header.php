...
<head>
    ...
    <link rel="canonical" href="http://localhost/r6stats-api-v2/index.php" />
    <!-- favicon -->
...
<body>
    <header class="header-nav"> 
        <div class="main-nav">
            <a class="logo" href="index.php">R6 Stats API</a>
            <a class="github" href="#"><i class="fab fa-github fa-lg"></i></a>
